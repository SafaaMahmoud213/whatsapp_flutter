...
class Chat2Body extends StatefulWidget {
  const Chat2Body({super.key});

  @override
  State<Chat2Body> createState() => _Chat2BodyState();
}

class _Chat2BodyState extends State<Chat2Body> {
